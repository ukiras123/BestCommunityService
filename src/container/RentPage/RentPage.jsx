    ...
    products: [
      {
        ...
        description: `-Rated highly for durability and value (see reviews)
      ...
      },
      {
        ...
        description: `Switch from bagging to mulching without tools or attachments
    ...
    products: [
      {
        ...
        description: `Ideal kit for most household projects
      ...
      },
      {
        ...
        description: `-1 flat head screwdrive
